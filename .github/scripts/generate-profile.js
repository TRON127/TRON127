...
function generateSVG(data) {
  ...
  // ═══════════════ FINAL SVG ═══════════════
  return `<!-- TRON127 Profile | Enhanced | Generated ${new Date().toISOString()} -->
...
${calendar}
${projects}
<text x="400" y="${totalH-16}" text-anchor="middle" font-family="${font}" font-size="8.5" fill="rgba(100,100,150,0.45)" font-weight="600" letter-spacing="2">TRON127 SYSTEMS \u2022 HIGH PERFORMANCE INFRASTRUCTURE</text>
</svg>`;
}
...
// Main
const username = process.env.GITHUB_USER || 'TRON127';
